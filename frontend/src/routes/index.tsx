          ...
          <div className="max-w-4xl mx-auto text-center space-y-10">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-zinc-400 max-w-2xl mx-auto font-light leading-relaxed tracking-tight">
                The objective benchmark for voice intelligence.{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
              ...
              >
                <RouterLink to="/signup">Enter Arena</RouterLink>
              </Button>
              <Button
                size="lg"
                variant="outline"
        ...
        <section className="px-6 py-32">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="space-y-6 text-lg text-zinc-400 font-light leading-relaxed">
              <p>
                The ecosystem is flooded with plugins. Quantity has outpaced
                quality.
                <span className="text-zinc-200 font-normal">
                  {" "}
                  The Arena exists to solve discovery through rigor.
                </span>
              </p>
              <p>
                By combining automated reference checks with community-driven
                preference testing, we create a self-correcting hierarchy of
                capability. No marketing fluff. Just raw performance data.
              </p>
            </div>
          </div>
        </section>
  ...
  return (
    <Card className="bg-black border border-white/10 hover:border-white/20 transition-colors duration-300 rounded-xl group">
      <CardHeader>
        ...
        <CardTitle className="text-lg font-medium text-zinc-200 tracking-tight">
          {title}
        </CardTitle>
      </CardHeader>
      <CardContent>
